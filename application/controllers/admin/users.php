...
class Users extends Admin_Controller{
    ...
    /**
     ...
     public function add(){
		...
		$this->data["districts"] = $this->user_model->getList("districts", "district_id", "district_name", $where ="`status` = 1");
		
		$this->data["directorates"] = $this->user_model->getList("directorates", "directorate_id", "directorate_name", $where ="`status` = 1");
		
		$this->data["hospitals"] = $this->user_model->getList("hospitals", "hospital_id", "hospital_name", $where ="`status` = 1");
