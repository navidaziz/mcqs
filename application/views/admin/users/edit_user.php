        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <?php
                    ...
                    echo form_label("District Name", "district_Id" , $label);
                ?>

                <div class="col-md-10">
                    <?php
					
					//echo $user->district_id;
					
					
                    echo form_dropdown("district_id", $districts, $user->district_id, "class=\"form-control\" required style=\"\"");
                    ?>
                </div>
