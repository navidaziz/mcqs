...
function get_marital_status(){
	$options = array("Married" => "Married", "Single" => "Single", "Widowed" => "Widowed");
	return $options;
	}
	
function get_religions(){
	$options = array("Muslim" => "Muslim", "Non Muslim" => "Non Muslim");
	return $options;
	}
	
function get_employment_status(){
	$options = array("Alive" => "Alive", "Terminated" => "Terminated", "Resigned" => "Resigned", "Deputation" => "Deputation",
	"Dead" => "Dead"
	 );
	return $options;
	}	
 ...
 */
 if(!function_exists('file_type')){
    ...
    function file_type($filename, $original = false,   $width=NULL, $height=NULL, $class='img-thumbnail'){
		$image_width="";
		$image_height="";	
		/*if($width){
			$image_width=$width;
        ...
        if(isset($ext) and strlen($ext) > 1){     
                ...
                if(in_array($ext, $images)){
                    ...
                    if($original == false){
						return "<img src='".$path_parts['dirname']."/".$path_parts['filename']."_thumb.".$ext."' height='".$height."' width='".$width."' class='".$class."' />";
                        ...
                        return "<img width='".$width."' height='".$height."' src='".$path_parts['dirname']."/".$path_parts['filename'].".".$ext."' class='".$class."' />";
